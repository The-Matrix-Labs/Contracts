...
contract PepeOfWallstreet is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pepe of Wallstreet", "PWS") {

        address _owner = msg.sender;

        _decimals = 18;

        uint256 totalSupply = 2000000000000 * (10**_decimals);
        ...
        marketingWallet = address(0xd9E5E47c2B80092Cef76C3A43057d3C30CE12637); // set as marketing wallet
