...
contract SoyjakChain is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Soyjak Chain Token", "SOY") {
        ...
        marketingWallet = address(0xc4D6e8DC88BC6d0D7702773413Eb9BB49918C102); // set as marketing wallet
